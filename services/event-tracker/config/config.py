...
# SQS
SQS_EVENT_TRACKER_QUEUE_NAME = os.environ.get("SQS_EVENT_TRACKER_QUEUE_NAME", default="__fake__")
SQS_EVENT_TRACKER_IDENTITY_QUEUE_NAME = os.environ.get(
    "SQS_EVENT_TRACKER_QUEUE_NAME", default="__fake__"
)
