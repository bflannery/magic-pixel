(function () {
    ...
    ***************************************************************************** */
    ...
    var EventTracker = /** @class */ (function () {
        ...
        // Context
        EventTracker.prototype._getStorageContext = function () {
        ...
        // Session
        EventTracker.prototype._getStorageSessionId = function () {
            return sessionStorage.getItem('mp_sid');
        };
        EventTracker.prototype._getStorageQueue = function () {
            var mpEventsQueue = localStorage.getItem('mp_events_queue');
            return mpEventsQueue ? JSON.parse(mpEventsQueue) : [];
        };
        EventTracker.prototype._loadQueue = function () {
            this.queue = this._getStorageQueue();
        };
        EventTracker.prototype._addToQueue = function (event) {
            this.queue = __spreadArray(__spreadArray([], this.queue, true), [event], false);
        };
        EventTracker.prototype._saveQueue = function () {
            localStorage.setItem('mp_events_queue', JSON.stringify(this.queue));
        };
        EventTracker.prototype._clearQueue = function () {
            this.queue = [];
        };
        EventTracker.prototype._dispatch = function () {
            var args = Array.prototype.slice.call(arguments, 0);
        ...
        // TRACKERS
        EventTracker.prototype._initTrackers = function () {
            this._trackClicks();
            this._trackLinkClicks();
            this._trackFormSubmits();
        };
        // Track all clicks to the document
        EventTracker.prototype._trackClicks = function () {
            var _this = this;
            onReady(function () {
        ...
        EventTracker.prototype._trackLinkClicks = function () {
            var _this = this;
        ...
        EventTracker.prototype._trackFormSubmits = function () {
            var _this = this;
        ...
        EventTracker.prototype._createEvent = function (eventType, properties) {
        ...
        EventTracker.prototype.trackScribeEvent = function (scribeEvent) {
            return __awaiter(this, void 0, void 0, function () {
                var event_1, MP, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log('Tracking Scribe: ', { scribeEvent: scribeEvent });
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            event_1 = __assign({ type: scribeEvent.value.event }, scribeEvent.value);
                            MP = window.MP;
                            if (!MP) {
    ...
    function init() {
        return __awaiter(this, void 0, void 0, function () {
            var siteId, MP, eventTracker, accountIsActive, newScript;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
